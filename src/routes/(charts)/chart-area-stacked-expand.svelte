<script lang="ts">
	...
	const chartData = [
		{ date: parseISO('2024-01-01'), desktop: 186, mobile: 80, other: 45 },
		{ date: parseISO('2024-02-01'), desktop: 305, mobile: 200, other: 100 },
		{ date: parseISO('2024-03-01'), desktop: 237, mobile: 120, other: 150 },
		{ date: parseISO('2024-04-01'), desktop: 73, mobile: 190, other: 50 },
		{ date: parseISO('2024-05-01'), desktop: 209, mobile: 130, other: 100 },
		{ date: parseISO('2024-06-01'), desktop: 214, mobile: 140, other: 160 }
	];
